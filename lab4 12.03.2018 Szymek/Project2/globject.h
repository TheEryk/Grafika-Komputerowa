...
int Normalize(float *N); // normalizuje wektor
int CalcNormal(float A[], float B[], float C[], float *N); // oblicza normalna


void MakeEgg(GLfloat A,GLfloat bk,GLfloat slices);
