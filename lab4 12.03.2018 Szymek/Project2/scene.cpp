...
{  
	...
	Egg->SetColor(0.5, 0.0, 0.5);
	Egg->MakeEgg(10, 2.0, 200.0);
	Egg->EndObject();
...
{	
	...
	glm::mat4 mModelView = glm::lookAt(glm::vec3(20.0f, 20.0f, 20.0f),
										glm::vec3(0.0f),
										glm::vec3(0.0f, 1.0f, 0.0f));
	glUniformMatrix4fv(_ModelView, 1, GL_FALSE, glm::value_ptr(mModelView));
	

	glm::vec3 LightDirection = glm::vec3(1.0, -1.0, -1.0); // kierunek swiatla 
	...
	int _A = glGetUniformLocation(program, "A");
	glUniform1f(_A, k);
