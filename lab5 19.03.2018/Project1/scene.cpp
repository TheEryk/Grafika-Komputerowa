...
{  
	...
	Face2 = new glTexture((char*)"textures\\sad.bmp");
	...
	Cube->BeginObject(GL_TRIANGLE_STRIP, Face2->Bind());
	Cube->AddVertex(-0.5, 0.5, 0.5, 0.0, 1.0);
	Cube->AddVertex(-0.5, -0.5, 0.5, 0.0, 0.0);
	Cube->AddVertex(0.5, 0.5, 0.5, 1.0, 1.0);
	Cube->AddVertex(0.5, -0.5, 0.5, 1.0, 0.0);
...
{            
	...
	switch(key)
	{
		...
		case 'W': {LightAmbient += 0.1f; break;} // F1		
		case 'S': {LightAmbient -= 0.1f; break;} //F2		
		case 'D': {Scale += 0.1f; break;} //F3		
		case 115: {Scale -= 0.1f; break;} //F4		
		case 32: {Cube->Switch(); break;}
	}
}
//--------------------------------------------------------------------------------------------
// rysuje scene OpenGL 
