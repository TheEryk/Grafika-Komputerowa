...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	try
	{
		...
		if (!CreateGLWindow((char*)PROJECT_NAME,wWidth,wHeight,16)) // utworz okno z widokiem sceny OPENGL
			return 0;

		SetTimer(hWnd,IDT_TIMER,10,(TIMERPROC) NULL); // ustaw obiekt timera 
